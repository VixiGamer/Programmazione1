...
public class AddFrame extends JFrame {
    ...
    public AddFrame(JFrame parent, GestoreGiochi gestore, Runnable onAddCallback) {
        ...
        setSize(400, 350); // Dimensioni leggermente aumentate
        setLocationRelativeTo(parent);
        setLayout(new GridBagLayout()); // Usato GridBagLayout
        ...
        JButton confermaBtn = new JButton("Aggiungi Gioco");
        ...
        gbc.gridx = 0; gbc.gridy = row; gbc.gridwidth = 2; gbc.weightx = 1.0; add(confermaBtn, gbc); // Bottone a larghezza intera
